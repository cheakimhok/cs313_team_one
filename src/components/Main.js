    ...
    render() {
        return (
            <div>
                ...
                <Switch>
                    <Redirect exact from={'/cs313_team_one'} to={'/BasicCalculator'} />
                    <Route exact path={'/'} component={BasicCal} />
                    <Route exact path={'/cs313_team_one'} component={BasicCal} />
                    <Route exact path={'/BasicCalculator'} component={BasicCal} />
                    {this.state.ready && (
                        <Route
                            path={'/signin'}
